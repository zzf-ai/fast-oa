...
import com.zzf.auth.mapper.SysMenuMapper;
import com.zzf.auth.service.SysMenuService;
import com.zzf.auth.service.SysRoleMenuService;
import com.zzf.auth.utils.MenuHelper;
...
//        }
    ...
    public void removeMenuById(Long id) {
        ...
        if(count > 0) {
            throw new CustomException(ResultCodeEnum.MENU_ERROR);
        }
...
//        List<SysMenu> sysMenuList = baseMapper.findMenuListByUserId(userId);
//
...
//    }
    ...
    @Override
    public MenuAndPermsVo findUserMenuAndPermsListByUserId(Long userId) {
        List<SysMenu> sysMenuList = baseMapper.findMenuListByUserId(userId);
        ...
        MenuAndPermsVo menuAndPermsVo = new MenuAndPermsVo(routerList, permsList);
        return menuAndPermsVo;
    }
